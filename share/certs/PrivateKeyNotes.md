...
unlocked to sign the Cocabit-Qt.app bundle.
...
allowing somebody to distribute a Cocabit-Qt.app or cocabit-qt-setup.exe with a valid
...
that the cocabit-qt.exe file inside the installer had not been tampered with.
