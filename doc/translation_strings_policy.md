...
This document provides guidelines for internationalization of the Cocabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cocabit_en.ts` remains unchanged.
