Download URL: https://sourceforge.net/projects/cocabit/files/Cocabit/cocabit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CBT fee schedule (users still pay 0.01 CBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cocabit00 - #cocabit99
