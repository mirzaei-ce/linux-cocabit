Cocabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cocabit/files/Cocabit/cocabit-0.5.4/
...
http://gitorious.org/cocabit/cocabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cocabit-Qt notifications under Growl 1.3.
Increase required age of Cocabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCocabit properly when installing Cocabit-Qt over it. (Windows)
