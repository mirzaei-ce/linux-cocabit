Cocabit Core version 0.9.2.1 is now available from:

  https://cocabit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CBT to 0.01 CBT
...
- Fix "Start cocabit on system login"
