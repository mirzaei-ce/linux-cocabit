Cocabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cocabit/files/Cocabit/cocabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cocabit
...
New/changed settings (command-line or cocabit.conf file)
--------------------------------------------------------
