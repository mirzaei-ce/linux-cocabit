Cocabit Core version 0.9.4 is now available from:

  https://cocabit.org/bin/0.9.4/
...
this update is incompatible with the Cocabit system and could lead to consensus
forks.

Cocabit Core released binaries from https://cocabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cocabit/+archive/ubuntu/cocabit
- A third-party or self-compiled Cocabit Core

upgrade to Cocabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
