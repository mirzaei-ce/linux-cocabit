...
#ifndef COCABIT_TEST_SCRIPTNUM10_H
#define COCABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cocabit Core 0.10.0, for cross-comparison.
 */
public:
