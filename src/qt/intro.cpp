...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/cocabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cocabit Core"),
     ...
     * override -datadir in the cocabit.conf file in the default data directory
     * (to be consistent with cocabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
