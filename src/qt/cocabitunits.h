...
#ifndef COCABIT_QT_COCABITUNITS_H
#define COCABIT_QT_COCABITUNITS_H
...
/** Cocabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CocabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CocabitUnits(QObject *parent);

    /** Cocabit units.
      @note Source: https://en.cocabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CBT,
...
typedef CocabitUnits::Unit CocabitUnit;

#endif // COCABIT_QT_COCABITUNITS_H
