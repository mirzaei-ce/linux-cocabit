...
#if defined(NDEBUG)
# error "Cocabit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cocabit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s CBT additional fees, %d delta bytes\n",
